...
urlpatterns = [
    ...
    path('add-article', views.add_article_view,name='add-artcile'),
    ...
    path('demarrer/', views.demarrer_enchere, name='demarrer_enchere'),
    path('enchere-en-cours/', views.enchere_en_cours, name='enchere_en_cours'),
    path('ajouter-offre/<int:product_id>/', views.ajouter_offre, name='ajouter_offre'),
